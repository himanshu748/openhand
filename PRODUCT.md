...
## Evidence on Hand
README.md, docs/live-verification.json, docs/snowflake-live-verification.json, docs/publication-live-verification.json, test/passiton.test.js and the public DEV challenge submission. Existing live finalized devnet transfer is documented. Microphone functionality was confirmed by the user.

## Product Principles
Make the next useful action obvious. Keep supporting sources accessible. Show review status accurately. Separate contribution from sponsor payment while making each technology role clear.

## Accessibility & Inclusion
English and Hindi answers, editable transcripts, speech playback, keyboard operation, visible focus, mobile layouts and reduced-motion support.
