...
const integrations = [
  ...
  },
  {
    key: 'snowflake',
    label: 'Snowflake',
    role: 'accountability metrics over ingested chain history',
    vars: ['SNOWFLAKE_ACCOUNT', 'SNOWFLAKE_USERNAME', 'SNOWFLAKE_PASSWORD', 'SNOWFLAKE_DATABASE'],
    optional: false,
  },
  {
    key: 'gemini',
